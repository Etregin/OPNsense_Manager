...
UnboundTotalCategory _$UnboundTotalCategoryFromJson(
  ...
  total: json['total'] == null
      ? 0
      : UnboundTotalCategory._parseInt(json['total']),
  pcnt: json['pcnt'] == null
      ? 0.0
      : UnboundTotalCategory._parseDouble(json['pcnt']),
);
...
UnboundTotals _$UnboundTotalsFromJson(
  ...
  total: json['total'] == null
      ? 0
      : UnboundTotalCategory._parseInt(json['total']),
  blocklistSize: json['blocklist_size'] == null
      ? 0
      : UnboundTotalCategory._parseInt(json['blocklist_size']),
  passed: json['passed'] == null
      ? 0
      : UnboundTotalCategory._parseInt(json['passed']),
