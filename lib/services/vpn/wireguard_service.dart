...
class WireGuardService extends BaseOPNsenseService {
  Future<List<WireGuardServer>> getWireGuardServers() async {
    ...
    try {
      final response = await dio.get('/api/wireguard/server/search_server');
  ...
  Future<WireGuardServer> getWireGuardServer(String uuid) async {
    ...
    try {
      final response = await dio.get('/api/wireguard/server/get_server/$uuid');
  ...
  Future<void> deleteWireGuardServer(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/server/del_server/$uuid');
  ...
  Future<List<WireGuardClient>> getWireGuardClients() async {
    ...
    try {
      final response = await dio.get('/api/wireguard/client/search_client');
  ...
  Future<WireGuardClient> getWireGuardClient(String uuid) async {
    ...
    try {
      final response = await dio.get('/api/wireguard/client/get_client/$uuid');
  ...
  Future<void> deleteWireGuardClient(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/client/del_client/$uuid');
  ...
  Future<List<WireGuardPeer>> getWireGuardPeers() async {
    ...
    try {
      final response = await dio.get('/api/wireguard/server/search_peer');
  ...
  Future<WireGuardPeer> getWireGuardPeer(String uuid) async {
    ...
    try {
      final response = await dio.get('/api/wireguard/server/get_peer/$uuid');
  ...
  Future<void> deleteWireGuardPeer(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/server/del_peer/$uuid');
  ...
  Future<WireGuardKeyPair> generateWireGuardKeyPair() async {
    ...
    try {
      final response = await dio.get('/api/wireguard/service/genkey');
  ...
  Future<void> applyWireGuardConfiguration() async {
    ...
    try {
      final response = await dio.post('/api/wireguard/service/reconfigure');
  ...
  Future<Map<String, dynamic>> getWireGuardStatus() async {
    ...
    try {
      final response = await dio.get('/api/wireguard/service/show');
  ...
  Future<void> restartWireGuardService() async {
    ...
    try {
      final response = await dio.post('/api/wireguard/service/restart');
  ...
  Future<void> startWireGuardInstance(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/service/start/$uuid');
  ...
  Future<void> stopWireGuardInstance(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/service/stop/$uuid');
  ...
  Future<void> restartWireGuardInstance(String uuid) async {
    ...
    try {
      final response = await dio.post('/api/wireguard/service/restart/$uuid');
